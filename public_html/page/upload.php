...
<div data-role="page" id="pgUpload" date-title="Upload Image">
	...
	<div data-role="content" class="ui-content">
		<img id="settingUserPhoto" src="./assets/member-photo.png" width='300'
			height='300' />
		<form action="" method="post" id="uploadForm"
			...
			<input type="submit" id="ajaxSubmit" name="submit" data-theme="a"
				value="上传！" />
			<!-- <div id="status"></div> -->
	...
	<div data-role="popup" id="uploadDialog" data-overlay-theme="b"
